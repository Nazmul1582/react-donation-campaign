...
const Banner = () => {
  return (
    <section className="bg-banner-img bg-cover bg-no-repeat bg-center">
      <div className="pt-36 pb-52 w-full h-full flex  justify-center items-center bg-white opacity-95">
      <div className="container mx-auto">
        <h2 className="text-center font-bold text-5xl mb-10">I Grow By Helping People In Need</h2>
